...
function show() {
    let count = 1
    table.innerHTML = `<thead><tr><th scope ="col">ID</th><th scope ="col">Ism Sharif</th><th scope ="col">Manzil</th><th scope="col">Dasturlash tillari</th> <th scope="col">Bo'lim </thead>`
    users.forEach(user =>{
